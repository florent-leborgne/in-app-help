  ...
  return (
    <KibanaLayout
      ...
      <EuiFormRow
        ...
        helpText="I am some friendly hint text. I am optionnal. I explain information necessary for filling a form or understanding what users can do with a setting or option. I should be 1 or 2 sentences, and definitely displayed on less than 2 lines.">
